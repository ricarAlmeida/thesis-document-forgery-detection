"""Training script for (RGB + ELA + PEP)-based document forgery localization."""
...
from models.segformer_b2_rgb_ela_pep_rtm.model_segformer_b2_rgb_ela_pep_rtm import SegFormerRGBELAPEPRunner


parser = argparse.ArgumentParser(description="Train RGB + ELA + PEP segmentation model")
...
parser.add_argument(
    "--save_root",
    type=str,
    default="./rtm_weights_segformer_b2_rgb_ela_pep",
    help="Directory where checkpoints and models will be saved",
)
parser.add_argument(
    "--logger_path",
    type=str,
    default="./rtm_train_segformer_b2_rgb_ela_pep.log",
    help="Training log file path",
)
parser.add_argument(
    "--tensorboard_path",
    type=str,
    default="./rtm_runs_segformer_b2_rgb_ela_pep",
...
# Model
# ---------------------------------------------------------------------
model = SegFormerRGBELAPEPRunner(
...
train_parameters = TrainParameters(
    model_name=f"segformer_b2-rgb-ela-pep-q2_{maxQF2}_{minQF2}-q3_{QF3}",
    epochs=epochs,
