"""Training script for MMSEG SegFormer-B2 RGB-based document forgery localization with classification head."""
...
from models.torchtools.torch_train_mmseg_segformer_b2_rgb_with_class_head_rtm import TrainParameters, train_fn
...
parser = argparse.ArgumentParser(description='Train RGB MMSEG segmentation model with classification head')
...
# Datasets
# ---------------------------------------------------------------------
dataset_train = DocForgeryDatasetClassHead(
...
dataset_val = DocForgeryDatasetClassHead(
...
train_parameters = TrainParameters(
    model_name = f"mmseg-segformer_b2-rgb-with-class-head",
    epochs=epochs,
...
class ClassificationLoss(_Loss):
    """Binary BCE loss for image-level classification."""
