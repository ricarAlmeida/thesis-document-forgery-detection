"""Training script for PEP-based document forgery localization with two auxiliary channels."""
...
from models.torchtools.torch_train_segformer_b2_pep_rtm import TrainParameters, train_fn

from models.doc_forgery_dataset_pep_rtm import DocForgeryPEPDataset
from models.segformer_b2_pep_2aux_rtm.model_segformer_b2_pep_2aux_rtm import SegFormerPEPAuxRunner


parser = argparse.ArgumentParser(description="Train PEP + 2aux segmentation model")
...
parser.add_argument(
    "--save_root",
    type=str,
    default="./rtm_weights_segformer_b2_pep_2aux",
    help="Directory where checkpoints and models will be saved",
)
parser.add_argument(
    "--logger_path",
    type=str,
    default="./rtm_train_segformer_b2_pep_2aux.log",
    help="Training log file path",
)
parser.add_argument(
    "--tensorboard_path",
    type=str,
    default="./rtm_runs_segformer_b2_pep_2aux",
...
train_parameters = TrainParameters(
    model_name=f"segformer_b2-pep-2aux-q2_{maxQF2}_{minQF2}-q3_{QF3}",
    epochs=epochs,
