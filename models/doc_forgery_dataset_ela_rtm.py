"""Dataset for document forgery localization using ELA features."""
...
class DocForgeryELADataset(Dataset):
    """
    Dataset for document forgery localization using ELA as the only auxiliary input.
    ...
    5. compute ELA from the final crop
    """
    ...
    def ela_features(
        ...
        tmp_dir = Path("/media/general_storage6/tmp_aux2")
