"""Training workflow implementation for (RGB + ELA + PEP)-based document forgery localization."""
...
from .torch_collate_segformer_b2_rgb_ela_pep_rtm import pad_collate
