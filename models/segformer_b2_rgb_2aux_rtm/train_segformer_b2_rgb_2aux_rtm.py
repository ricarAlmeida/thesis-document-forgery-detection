"""Training script for RGB-based document forgery localization with two auxiliary channels."""
...
from models.torchtools.torch_train_segformer_b2_rgb_rtm import TrainParameters, train_fn

from models.doc_forgery_dataset_rgb_rtm import DocForgeryDataset
from models.segformer_b2_rgb_2aux_rtm.model_segformer_b2_rgb_2aux_rtm import SegFormerRGBAuxRunner


parser = argparse.ArgumentParser(description="Train RGB + 2aux segmentation model")
...
parser.add_argument(
    "--save_root",
    type=str,
    default="./rtm_weights_segformer_b2_rgb_2aux",
    help="Directory where checkpoints and models will be saved",
)
parser.add_argument(
    "--logger_path",
    type=str,
    default="./rtm_train_segformer_b2_rgb_2aux.log",
    help="Training log file path",
)
parser.add_argument(
    "--tensorboard_path",
    type=str,
    default="./rtm_runs_segformer_b2_rgb_2aux",
...
train_parameters = TrainParameters(
    model_name = f"segformer_b2-rgb-2aux",
    epochs=epochs,
