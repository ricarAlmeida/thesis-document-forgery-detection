"""Training script for MMSEG SegFormer-B2 RGB-based document forgery localization."""
...
from models.torchtools.torch_train_mmseg_segformer_b2_rgb_rtm import TrainParameters, train_fn

from models.doc_forgery_dataset_rgb_rtm import DocForgeryDataset
from models.segformer_b2_mmseg_rgb_rtm.model_segformer_b2_mmseg_rgb_rtm import SegFormerMMSEG_RGBRunner


parser = argparse.ArgumentParser(description='Train RGB MMSEG segmentation model')
...
parser.add_argument(
    "--checkpoint",
    type=str,
    default="./weights_mmseg_segformer_b2_rgb_rtm_corretoo/mmseg-segformer_b2-rgb/"
    #default=None,
...
parser.add_argument(
    "--save_root",
    type=str,
    default="./weights_mmseg_segformer_b2_rgb_rtm_corretoo",
    help="Directory where checkpoints and models will be saved",
)
parser.add_argument(
    "--logger_path",
    type=str,
    default="./train_mmseg_segformer_b2_rgb_rtm_corretoo.log",
    help="Training log file path",
)
parser.add_argument(
    "--tensorboard_path",
    type=str,
    default="./runs_mmseg_segformer_b2_rgb_rtm_corretoo",
...
# Model
# ---------------------------------------------------------------------
model = SegFormerMMSEG_RGBRunner(
...
train_parameters = TrainParameters(
    model_name = f"mmseg-segformer_b2-rgb",
    epochs=epochs,
