"""Training script for (RGB + PEP)-based document forgery localization with two auxiliary channels."""
...
from models.torchtools.torch_train_segformer_b2_rgb_pep_rtm import TrainParameters, train_fn

from models.doc_forgery_dataset_pep_rtm import DocForgeryPEPDataset
from models.segformer_b2_rgb_pep_2aux_rtm.model_segformer_b2_rgb_pep_2aux_rtm import SegFormerRGBPEPAuxRunner


parser = argparse.ArgumentParser(description="Train RGB + PEP + 2aux segmentation model")

parser.add_argument(
    "--minQF_2",
    type=int,
    required=True,
    help="Minimum JPEG quality factor used in training data generation",
)
parser.add_argument(
    "--maxQF_2",
    type=int,
    required=True,
    help="Maximum JPEG quality factor used in training data generation",
)
parser.add_argument(
    "--QF_3",
    type=int,
    required=True,
    help="JPEG quality factor used for PEP extraction",
)
parser.add_argument(
    "--images_repo",
    nargs="+",
    ...
    help="Image repositories in the form [train_images, val_images]",
)
parser.add_argument(
    "--masks_repo",
    nargs="+",
    ...
    help="Mask repositories in the form [train_masks, val_masks]",
)
parser.add_argument(
    "-N",
    "--epochs",
...
parser.add_argument(
    ...
    type=int,
    default=64,
    help="Effective batch size through gradient accumulation",
)
parser.add_argument(
    "--checkpoint",
    type=str,
...
parser.add_argument(
    "--save_root",
    type=str,
    default="./rtm_weights_segformer_b2_50_rgb_pep_2aux",
    help="Directory where checkpoints and models will be saved",
)
parser.add_argument(
    "--logger_path",
    type=str,
    default="./rtm_train_segformer_b2_rgb_pep_2aux.log",
    help="Training log file path",
)
parser.add_argument(
    "--tensorboard_path",
    type=str,
    default="./rtm_runs_segformer_b2_rgb_pep_2aux",
...
# Model
# ---------------------------------------------------------------------
model = SegFormerRGBPEPAuxRunner(
...
# Datasets
# ---------------------------------------------------------------------
dataset_train = DocForgeryPEPDataset(
...
dataset_val = DocForgeryPEPDataset(
...
# Quality factor used for PEP extraction
...
train_parameters = TrainParameters(
    model_name=f"segformer_b2-rgb-pep-2aux-q2_{maxQF2}_{minQF2}-q3_{QF3}",
    epochs=epochs,
