""" Test script (SegFormer-B2 + RGB only) """
...
ckpt_path = "/media/generalstorage5/weights_segformer_b2/segformer-b2-rgb-batchnorm/2026-05-26 20:31:41.621223-checkpoint99.pth"
...
evaluate(
    ...
    metrics=metrics,
    device=device,
    save_path="./models/test_doctamper_rgb_outputs/test_segformer_b2_rgb_all_epochs.json",
)