"""Training script for ELA-based document forgery localization with two auxiliary channels."""
...
from models.segformer_b2_ela_2aux_rtm.model_segformer_b2_ela_2aux_rtm import SegFormerELAAuxRunner


parser = argparse.ArgumentParser(description="Train ELA + 2aux segmentation model")
...
parser.add_argument(
    "--save_root",
    type=str,
    default="./rtm_weights_segformer_b2_ela_2aux",
    help="Directory where checkpoints and models will be saved",
)
parser.add_argument(
    "--logger_path",
    type=str,
    default="./rtm_train_segformer_b2_ela_2aux.log",
    help="Training log file path",
)
parser.add_argument(
    "--tensorboard_path",
    type=str,
    default="./rtm_runs_segformer_b2_ela_2aux",
...
train_parameters = TrainParameters(
    model_name = f"segformer_b2-ela-2aux-q3_{QF3}",
    epochs=epochs,
...
writer = SummaryWriter(
     ...
     / f"h:{height}_w:{width}_epochs:{epochs}_batch:{batch_size}_lr_base:0.005"
 )
