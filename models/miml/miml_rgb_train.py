...
parser = argparse.ArgumentParser(description='Train Args (MIML + RGB only)')
...
parser.add_argument(
    "--save_root",
    type=str,
    default="./doctamper_weights_miml_100_rgb",
    help="Model checkpoints directory path",
)
parser.add_argument(
    "--logger_path",
    type=str,
    default="./doctamper_train_miml_100_rgb.log",
    help="Training logs path",
)
parser.add_argument(
    "--tensorboard_path",
    type=str,
    default="./doctamper_runs_miml_100_rgb",
...
train_parameters = TrainParameters(
    model_name = f"miml-rgb-batchnorm",
    epochs=epochs,
