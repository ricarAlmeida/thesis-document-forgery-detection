"""Training script for (RGB + ELA + PEP)-based document forgery localization with two auxiliary channels."""
...
from models.torchtools.torch_train_segformer_b2_rgb_ela_pep_rtm import TrainParameters, train_fn

from models.doc_forgery_dataset_ela_pep_rtm import DocForgeryELAPEPDataset
from models.segformer_b2_rgb_ela_pep_2aux_rtm.model_segformer_b2_rgb_ela_pep_2aux_rtm import SegFormerRGBELAPEPAuxRunner


parser = argparse.ArgumentParser(description="Train RGB + ELA + PEP + 2aux segmentation model")
...
parser.add_argument(
    ...
    type=int,
    required=True,
    help="JPEG quality factor used for PEP and ELA extraction",
)
parser.add_argument(
    "--images_repo",
    nargs="+",
...
parser.add_argument(
    "--save_root",
    type=str,
    default="./rtm_weights_segformer_b2_rgb_ela_pep_2aux",
    help="Directory where checkpoints and models will be saved",
)
parser.add_argument(
    "--logger_path",
    type=str,
    default="./rtm_train_segformer_b2_rgb_ela_pep_2aux.log",
    help="Training log file path",
)
parser.add_argument(
    "--tensorboard_path",
    type=str,
    default="./rtm_runs_segformer_b2_rgb_ela_pep_2aux",
...
# Model
# ---------------------------------------------------------------------
model = SegFormerRGBELAPEPAuxRunner(
...
# Datasets
# ---------------------------------------------------------------------
dataset_train = DocForgeryELAPEPDataset(
...
dataset_val = DocForgeryELAPEPDataset(
...
# Quality factor used for ELA and PEP extraction
...
train_parameters = TrainParameters(
    model_name=f"segformer_b2-rgb-ela-pep-2aux-q2_{maxQF2}_{minQF2}-q3_{QF3}",
    epochs=epochs,
