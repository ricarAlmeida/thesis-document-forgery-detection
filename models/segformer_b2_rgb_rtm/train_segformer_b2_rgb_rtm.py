"""Training script for RGB-based document forgery localization."""
...
from models.segformer_b2_rgb_rtm.model_segformer_b2_rgb_rtm import SegFormerRGBRunner


parser = argparse.ArgumentParser(description="Train RGB segmentation model")
...
parser.add_argument(
    "--save_root",
    type=str,
    default="./rtm_weights_segformer_b2_rgb",
    help="Directory where checkpoints and models will be saved",
)
parser.add_argument(
    "--logger_path",
    type=str,
    default="./rtm_train_segformer_b2_rgb.log",
    help="Training log file path",
)
parser.add_argument(
    "--tensorboard_path",
    type=str,
    default="./rtm_runs_segformer_b2_rgb",
