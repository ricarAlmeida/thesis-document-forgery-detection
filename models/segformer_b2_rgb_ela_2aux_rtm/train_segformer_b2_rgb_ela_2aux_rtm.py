"""Training script for (RGB + ELA)-based document forgery localization with two auxiliary channels."""
...
from models.torchtools.torch_train_segformer_b2_rgb_ela_rtm import TrainParameters, train_fn

from models.doc_forgery_dataset_ela_rtm import DocForgeryELADataset
from models.segformer_b2_rgb_ela_2aux_rtm.model_segformer_b2_rgb_ela_2aux_rtm import SegFormerRGBELAAuxRunner


parser = argparse.ArgumentParser(description="Train RGB + ELA + 2aux segmentation model")
...
parser.add_argument(
    "--save_root",
    type=str,
    default="./rtm_weights_segformer_b2_rgb_ela_2aux",
    help="Directory where checkpoints and models will be saved",
)
parser.add_argument(
    "--logger_path",
    type=str,
    default="./rtm_train_segformer_b2_rgb_ela_2aux.log",
    help="Training log file path",
)
parser.add_argument(
    "--tensorboard_path",
    type=str,
    default="./rtm_runs_segformer_b2_rgb_ela_2aux",
...
# Model
# ---------------------------------------------------------------------
model = SegFormerRGBELAAuxRunner(
...
train_parameters = TrainParameters(
    model_name = f"segformer_b2-rgb-ela-2aux-q3_{QF3}",
    epochs=epochs,
