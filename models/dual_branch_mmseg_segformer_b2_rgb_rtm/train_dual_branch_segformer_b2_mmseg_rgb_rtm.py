"""Training script for dual-branch MMSEG SegFormer-B2 RGB-based document forgery localization and classification / image_only branch."""
...
from models.dual_branch_mmseg_segformer_b2_rgb_rtm.model_dual_branch_segformer_b2_mmseg_rgb_rtm import SegFormerRGBRunner    #SegFormerImageOnlyRunner


parser = argparse.ArgumentParser(description='Train dual-branch RGB MMSEG segmentation model / image_only branch')
...
# Model
# ---------------------------------------------------------------------
model = SegFormerRGBRunner(  # or SegFormerImageOnlyRunner
...
train_parameters = TrainParameters(
    model_name = f"dual-image-only-branch-mmseg-segformer_b2-rgb",
    epochs=epochs,
